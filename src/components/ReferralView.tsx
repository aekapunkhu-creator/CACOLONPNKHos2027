                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    {onEditPatient && (
                      <button
                        ...
                        className="px-3 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 rounded-xl text-xs font-semibold transition-all flex items-center gap-1.5"
                        title="แก้ไขประวัติและผลตรวจผู้ป่วย"
                      >
                    ...
                    {onDeletePatient && (
                      <button
                        type="button"
                        onClick={() => onDeletePatient(currentPatient)}
                        className="px-3 py-2 bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200 rounded-xl text-xs font-semibold transition-all flex items-center gap-1.5"
                        title="ลบข้อมูลผู้ป่วย"
                      >
